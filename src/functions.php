 ...
 *
 * @return bool
 * @throws \InvalidArgumentException If not acceptable type of check
 */
    ...
    if (is_array($varName)) {
        ...
        switch ($type) {
            ...
            case B_FORM_TYPE_POST:
                ...
                break;
            default:
                throw new InvalidArgumentException('Not good check type, acceptable: "B_FORM_TYPE_GET" or "B_FORM_TYPE_POST" constant');
        }
